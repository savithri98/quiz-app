...
def create_pdf(questions, user_answers):
    ...
    for idx, q in enumerate(questions):
        ...
        # Handle unicode roughly or just encode/decode to avoid FPDF latin-1 errors
...
def generate_questions(domain, difficulty, api_key):
    ...
    # Using gemini-2.5-flash as tested earlier
...
st.markdown("<p style='text-align: center;'>Master any domain with dynamic, AI-generated questions</p>", unsafe_allow_html=True)
